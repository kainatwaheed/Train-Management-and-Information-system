...
class TrainsControllerTest < ActionController::TestCase
  ...
  test "should create train" do
    assert_difference('Train.count') do
      post :create, train: { name: @train.name, noofclasses: @train.noofclasses, noofseats: @train.noofseats }
    end
  ...
  test "should update train" do
    patch :update, id: @train, train: { name: @train.name, noofclasses: @train.noofclasses, noofseats: @train.noofseats }
    assert_redirected_to train_path(assigns(:train))
  end
