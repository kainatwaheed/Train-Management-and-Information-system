...
class SeatsControllerTest < ActionController::TestCase
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post :create, seat: { deptdate: @seat.deptdate, seat1: @seat.seat1, seat2: @seat.seat2, seat3: @seat.seat3, tname: @seat.tname, trainroute_id: @seat.trainroute_id }
    end
  ...
  test "should update seat" do
    patch :update, id: @seat, seat: { deptdate: @seat.deptdate, seat1: @seat.seat1, seat2: @seat.seat2, seat3: @seat.seat3, tname: @seat.tname, trainroute_id: @seat.trainroute_id }
    assert_redirected_to seat_path(assigns(:seat))
  end
