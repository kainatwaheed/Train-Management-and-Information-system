  ...
  var mapOptions = {
   ...
   // geocoding 
      var geocoding  = new google.maps.Geocoder();
        var geocoding1  = new google.maps.Geocoder();
    $("#submit_button_geocoding").click(function(){
        codeAddress(geocoding,geocoding1);
      });
...
function codeAddress(geocoding,geocoding1){
  ...
  var address1 = $("#search_box1_geocoding").val();
  if(address1.length > 0){
    geocoding1.geocode({'address': address1},function(results, status){
      if(status == google.maps.GeocoderStatus.OK){
        map.setCenter(results[0].geometry.location);
